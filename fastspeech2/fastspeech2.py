...
class FastSpeech2(nn.Module):
    ...
    def __init__(self, speaker_encoder, use_postnet=True):
    ...
    def forward(self, src_seq, src_len, mel_spec, mel_len=None, d_target=None, p_target=None, e_target=None, max_src_len=None,
